...
def gen_cluster_random(num=1000):
...
def gen_trajectory_random(num=1000):
    if np.random.uniform() < 0.5:
...
def gen_random(num=1000, mode='random'):
    if mode == 'random':
